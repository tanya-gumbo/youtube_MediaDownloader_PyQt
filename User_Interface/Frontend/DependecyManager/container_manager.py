...
from User_Interface.Frontend.MainApplication.custom_status_menu_item import CustomStatusMenuItems
from User_Interface.Frontend.MainApplication.main_window import MainWindow
from User_Interface.Frontend.SettingsWindow.Settings import Settings, SideBar


def register_dependencies_in_container():
    container = Container()
    container.register('settings', Settings)
    container.register('side_bar', SideBar)
